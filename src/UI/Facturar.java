...
public class Facturar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 290, 550, 310));
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 170, -1, 30));
        ...
        jPanel2.add(cbx_Cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 140, 130, -1));
        ...
        jPanel2.add(jSeparator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 230, 420, 10));
        ...
        jPanel2.add(cbx_Senor, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 180, 420, 20));
    ...
    private void tablaInventarioMouseClicked(java.awt.event.MouseEvent evt) {                                             
    ...
    private void txt_TallaKeyTyped(java.awt.event.KeyEvent evt) {                                   
        validarNumeros(evt);
    }                                  

    private void cbx_TipoProductoActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void labBuscarAvanzadaMouseClicked(java.awt.event.MouseEvent evt) {                                               
    ...
    private void labBuscarAvanzadaMouseEntered(java.awt.event.MouseEvent evt) {                                               
        labBuscarAvanzada.setCursor(new Cursor(Cursor.HAND_CURSOR));
    }                                              

    private void labDropdownMouseClicked(java.awt.event.MouseEvent evt) {                                         
    ...
    private void labDropdownMouseEntered(java.awt.event.MouseEvent evt) {                                         
    ...
    private void txt_colorActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void labCloseMouseClicked(java.awt.event.MouseEvent evt) {                                      
        this.dispose();
        new Menu_Principal().setVisible(true);
    }                                     

    private void labCloseMouseEntered(java.awt.event.MouseEvent evt) {                                      
        labClose.setCursor(new Cursor(Cursor.HAND_CURSOR));
    }                                     

    private void btnPanelAgregarMouseEntered(java.awt.event.MouseEvent evt) {                                             
        btnPanelAgregar.setCursor(new Cursor(Cursor.HAND_CURSOR));
    }                                            

    private void btnPanelAgregarMouseClicked(java.awt.event.MouseEvent evt) {                                             
    ...
    private void btnPanelEliminarMouseClicked(java.awt.event.MouseEvent evt) {                                              
    ...
    private void btnPanelEliminarMouseEntered(java.awt.event.MouseEvent evt) {                                              
        btnPanelEliminar.setCursor(new Cursor(Cursor.HAND_CURSOR));
    }                                             

    private void btnPanelFacturarMouseClicked(java.awt.event.MouseEvent evt) {                                              
        // TODO add your handling code here:
    ...
    private void btnPanelFacturarMouseEntered(java.awt.event.MouseEvent evt) {                                              
        btnPanelFacturar.setCursor(new Cursor(Cursor.HAND_CURSOR));
    }                                             

    private void cbx_CedulaActionPerformed(java.awt.event.ActionEvent evt) {                                           
        String cadena = cbx_Cedula.getEditor().getItem().toString();
        buscarPorCedula(cadena);
    }                                          

    private void cbx_SenorActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String cadena = cbx_Senor.getEditor().getItem().toString();
        buscarPorNombreCompleto(cadena);
    }                                         
